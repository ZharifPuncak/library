    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
            ...
            <div class="mb-5">
                ...
                <p class="text-sm text-slate-500">Your personal collection of saved collections.</p>
            </div>
            ...
            <div>
                ...
                @if($collections->isEmpty())
                    <div class="py-10 text-center text-slate-400 text-sm border border-dashed border-slate-200 rounded-lg">
