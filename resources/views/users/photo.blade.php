...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ filterMobileOpen: false }">
    ...
    <div class="flex flex-col md:flex-row gap-4 mb-12">
        <div class="flex-grow relative group">
            <form action="{{ route('assets.photos') }}" method="GET" class="relative">
                ...
                @if(request('search'))
                    <a href="{{ route('assets.photos', request()->except('search')) }}" 
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 auto-rows-fr">
        ...
        @empty
            <div class="col-span-full py-20 text-center">
                ...
                <a href="{{ route('assets.photos') }}" class="inline-block mt-8 px-10 py-4 bg-lib-blue text-white rounded-2xl font-black hover:bg-lib-navy transition-all shadow-xl shadow-lib-blue/20">Back to Archive</a>
            </div>
        @endforelse
    </div>
    ...
    <template x-teleport="body">
        <div x-show="filterMobileOpen" x-cloak 
            ...
            <div @click.away="filterMobileOpen = false" 
                ...
                <form action="{{ route('assets.photos') }}" method="GET" class="space-y-10">
                    <div>
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        @if(request()->hasAny(['categories', 'year']))
                            <a href="{{ route('assets.photos', request()->only('search')) }}" 
