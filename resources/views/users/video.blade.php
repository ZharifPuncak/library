...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ filterMobileOpen: false }">
    <!-- Header -->
    <div class="mb-10">
        <h1 class="text-4xl font-black text-lib-navy uppercase tracking-tighter mb-2">Corporate Videos</h1>
        <p class="text-slate-500 font-medium text-lg">Stream project briefings, operational highlights, and corporate footage in high definition.</p>
    </div>
