    ...
    <div class="hero-overlay">
        <div class="hero-content">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('assets.all') }}" class="bg-white text-lib-navy px-8 py-3 rounded-full font-bold hover:bg-lib-sky hover:text-white transition-all shadow-lg">Browse Media</a>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-12">
            ...
            <button @click="filterModalOpen = true" 
                    class="relative px-7 py-3 bg-white text-lib-navy border-2 border-slate-100 rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-lib-light transition-all shadow-lg hover:shadow-xl text-sm">
            ...
            @if(isset($mostViewed) && $mostViewed->count() > 0)
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    @foreach($mostViewed as $asset)
                        <a href="{{ route('assets.show', $asset->id) }}" class="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-slate-100 flex flex-col relative font-fredoka">
                                ...
                                @elseif($asset->type === 'ebook')
                                    <div class="w-full h-full flex flex-col items-center justify-center overflow-hidden">
                                        ...
                                        @else
                                            ...
                                            <div class="w-full h-full bg-gradient-to-br from-lib-navy to-lib-sky flex flex-col items-center justify-center text-white p-4">
                                                <div class="w-12 h-16 bg-white/10 rounded-lg flex items-center justify-center border border-white/20 mb-2 group-hover:scale-110 transition-transform">
                                                    <span class="text-2xl">📚</span>
                                                </div>
                                                <span class="text-[8px] font-black uppercase tracking-widest opacity-60">Digital Resource</span>
                                            </div>
                                        @endif
                                    </div>
                                @endif
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- All Media -->
            <a href="{{ route('assets.all') }}" class="access-card group p-8 rounded-[2rem] text-white">
            ...
            <!-- Photos -->
            <a href="{{ route('assets.photos') }}" class="access-card group p-8 rounded-[2rem] text-white">
                <div class="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-3xl group-hover:scale-110 transition-transform">📸</div>
            ...
            <!-- Videos -->
            <a href="{{ route('assets.videos') }}" class="access-card group p-8 rounded-[2rem] text-white">
                <div class="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-3xl group-hover:scale-110 transition-transform">🎬</div>
            ...
            <!-- Ebooks -->
            <a href="{{ route('assets.ebooks') }}" class="access-card group p-8 rounded-[2rem] text-white">
                <div class="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-3xl group-hover:scale-110 transition-transform">📚</div>
