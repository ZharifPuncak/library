...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        ...
        {{-- Assets Grid (Matching user collections) --}}
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 auto-rows-fr">
            @foreach($assets as $asset)
                ...
                <div class="relative h-48 overflow-hidden bg-slate-100 group">
                    <a href="{{ route('admin.collections.asset.show', [$collectionName, $asset->id]) }}" class="block h-full w-full">
                        @php
                    ...
                    {{-- Admin Action Buttons (Enhanced for Mobile) --}}
                    <div class="absolute inset-x-0 top-0 p-4 flex justify-end gap-2 transition-all duration-300">
                        ...
                        <form action="{{ route('admin.assets.destroy', $asset->id) }}" method="POST" class="inline">
                            @csrf 
                            @method('DELETE')
                            <button type="submit" class="delete-confirm w-10 h-10 rounded-full bg-white/90 backdrop-blur text-red-500 shadow-lg flex items-center justify-center hover:bg-red-500 hover:text-white transition-all transform hover:scale-110 border-0 p-0"
                ...
                <div class="p-4 flex-grow flex flex-col">
                    <div class="flex-grow">
                        ...
                        <a href="{{ route('admin.collections.asset.show', [$collectionName, $asset->id]) }}" class="block">
